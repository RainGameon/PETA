...
def run(_run, _config, _log):
    ...
    os.environ['SC2PATH'] = '/root/EMC/pymarl/3rdparty/StarCraftII'
    # check args sanity
...
def run_sequential(args, logger):
    ...
    # Learner
    if args.learner=="fast_QLearner" or args.learner == "qplex_curiosity_vdn_learner_ca" or args.learner == "qplex_curiosity_vdn_learner_ind" or args.learner=="qplex_curiosity_vdn_learner" or args.learner=="max_q_learner":
