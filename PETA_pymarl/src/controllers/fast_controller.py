...
class FastMAC:
    def __init__(self, scheme, groups, args):
        ...
        self.args = args
        self.input_shape = self._get_input_shape(scheme) # 186
    ...
    def forward(self, ep_batch, t, test_mode=False, batch_inf=False):
        agent_inputs = self._build_inputs(ep_batch, t, batch_inf) # [9, 1, 186]
        # print('SUNMENGYAO_________________mac: agent_inputs={}'.format(agent_inputs.shape))
    ...
    def _build_inputs(self, batch, t, batch_inf):
        ...
        if batch_inf:
            ...
            bs = batch.batch_size # 1
            # print('SUNMENGYAO_________________mac: batch_size={}'.format(bs))
            inputs = []
    ...
    def _get_input_shape(self, scheme):
        input_shape = scheme["obs"]["vshape"] # 162
        # print('SUNMENGYAO_________________mac: inputs_shape1 = ', input_shape) # 162
        if self.args.obs_last_action:
            input_shape += scheme["actions_onehot"]["vshape"][0] # 177
            # print('SUNMENGYAO_________________mac: inputs_shape2 = ', input_shape)  
        if self.args.obs_agent_id:
            input_shape += self.n_agents # 186
            # print('SUNMENGYAO_________________mac: inputs_shape3 = ', input_shape)  # [9, 1, 186]
        return input_shape  # 186
